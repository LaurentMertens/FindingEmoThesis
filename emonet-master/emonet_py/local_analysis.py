...
def local_analysis(file_path, file_name, show_box=False):
    ...
    with torch.no_grad():
        ...
        grayscale_cam_tensor = transform(grayscale_cam_pil)
        ...
        with torch.no_grad():
            ...
            df_complete = add_importance(output_df, grayscale_cam_scaled)
            df_complete = confidence_cutoff(df_complete, threshold=0.1)
